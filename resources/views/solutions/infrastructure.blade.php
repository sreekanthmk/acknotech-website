...
<div class="container" id="secondary">
    <div class="row">
      <div class="col-md-4">
        <div id="slideshow">
           <div>
             <img src="/../images/infrastructure1.jpg">
           </div>
        </div>
      </div>
      <div class="col-md-8">
        ...
        <br><hr>
        <p>This service is focused on managing the IT Infrastructure and ensuring the highest levels of availability for the business applications to function without interruption. Service options are customized to include
        ...
        <div class="row">
            ...
            <ul>
             ...
             <div class="col-md-6">
                <img class = "tech-img" src="/../images/infrastructure2.jpg">
